...
def get_splatter(
    ...
    if name == "xyblending":
        from .z_buffer_layers import RasterizePointsXYsBlending
...
class PtsManipulator(nn.Module):
    def __init__(self, W, C=64, opt=None):
        ...
        self.splatter = get_splatter(
            "xyblending", None, opt, size=W, C=C, points_per_pixel=opt.pp_pixel
        )
    ...
    def forward_justpts(
        self, src, pred_pts, K, K_inv, RT_cam1, RTinv_cam1, RT_cam2, RTinv_cam2, hook=None):
