...
class DataDownloader:
    def __init__ (self, dataroot, mode='test'):
        ...
        self.output_root = '/home/xxy/Documents/data/RealEstate10K/videos' + mode + '/'
        self.mode =  mode
    ...
    def Run(self):
        ...
        for global_count, data in enumerate(self.list_data):
            ...
            try :
                ...
                stream.download('./','current_'+mode+'.tmp')
            except :
            ...
            videoname_candinate_list = glob.glob('./*.tmp')
...
if __name__ == "__main__":
    ...
    dataroot = "/home/xxy/Documents/data/RealEstate10K/" + mode
